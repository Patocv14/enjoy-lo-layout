...
import topSplash from './assets/top_splash_placeholder_blue.svg';
import jungSplash from './assets/jung_splash_placeholder_blue.svg';
import midSplash from './assets/mid_splash_placeholder_blue.svg';
import botSplash from './assets/bot_splash_placeholder_blue.svg';
import supSplash from './assets/sup_splash_placeholder_blue.svg';

import topSplashRed from './assets/top_splash_placeholder_red.svg';
import jungSplashRed from './assets/jung_splash_placeholder_red.svg';
import midSplashRed from './assets/mid_splash_placeholder_red.svg';
import botSplashRed from './assets/bot_splash_placeholder_red.svg';
import supSplashRed from './assets/sup_splash_placeholder_red.svg';

const pickSplashes = [topSplash, jungSplash, midSplash, botSplash, supSplash];

const pickSplashesRed = [
  topSplashRed,
  jungSplashRed,
  midSplashRed,
  botSplashRed,
...
const putPlaceholdersRed = (team, backendUrl) => {
  for (let i = 0; i < 5; i++) {
    // Picks
    // Check if exists
    if (i >= team.picks.length) {
...
const convertState = (state, backendUrl) => {
  if (Object.keys(state).length !== 0) {
    ...
    putPlaceholdersRed(state.redTeam, backendUrl);
  }
  return state;
};
